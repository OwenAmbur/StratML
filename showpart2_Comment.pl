...
# $surl="http://xml.fido.gov/stratml/references/PerformancePlanOrReportISOVersion20150612.xsd";
#$surl="http://stratml.us/references/PerformancePlanOrReportISOVersion20150612.xsd";
$surl="http://stratml.us/references/PerformancePlanOrReport20160216.xsd";
# Alternative for when xml.fido.gov retires: http://stratml.us/references/PerformancePlanOrReportISOVersion20150612.xsd

my $myfile ="temp/temp.xml";
...
# 11/12/2015
$posted_information=~s|<[^>]*?>|<PerformancePlanOrReport xmlns="urn:ISO:std:iso:17469:tech:xsd:PerformancePlanOrReport" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
...
# $posted_information=~s|<[^>]*?>|<PerformancePlanOrReport xmlns="urn:ISO:std:iso:17469:tech:xsd:PerformancePlanOrReport" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:ISO:std:iso:17469:tech:xsd:PerformancePlanOrReport http://xml.fido.gov/stratml/references/PerformancePlanOrReportISOVersion20150612.xsd" Type="$plantype">|;
...
#print $doc;
$xmlschema = XML::LibXML::Schema->new( location =>$surl);

my $e;
 	{
	$d= $xmlschema->validate( $doc ); 
	eval { $xmlschema->validate( $doc );  };

        $@ =~ /error/ and $e = $@;
	}  print "Content-type: text/html\n\n<html><body>ERROR: ".$e."</body></html>" if defined $e;
...
if ($d==0) {
		print "Content-type: text/html\n\n";	
		print "<html><head>";
		print "  <meta http-equiv=\"Refresh\" content=\"0; url=http://stratml.us/forms/temp/temp.xml\">\n";
		print "</head><body>";
		print "  <p>Please follow <a href=\"http://stratml.us/forms/temp/temp.xml\">link</a>!</p>\n";
		print "</body></html>\n";
		exit; }
...
$uuid1=$highest+1;
while ($posted_information=~s|<Identifier>\[To[_ ]be[_ ]identified\]</Identifier>|<Identifier>PLACEHOLDER_$uuid1</Identifier>|)
	{	
	$uuid1++;
	}

$posted_information=~s|<Identifier>([0-9])|<Identifier>_\1|g;
$posted_information=~s|<Identifier>-|<Identifier>_|g;
