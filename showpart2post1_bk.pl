...
# exit;
		...
		print "Content-type: text/html\n\n";	
		print "<html><head>";
		print "  <meta http-equiv=\"Refresh\" content=\"0; url= http://stratml.us/forms/temp-stratml/temp.xml\">\n";
		print "</head><body>";
		print "  <p>Please follow <a href=\"http://stratml.us/forms/temp-stratml/temp.xml\">link</a>!</p>\n";
		print "</body></html>\n";
		exit;
